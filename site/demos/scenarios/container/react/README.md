...
React callback refs store both committed DOM elements in state. The selected immutable DOM value is passed directly through the public `sourceRoot` and `scrollRoot` props.
